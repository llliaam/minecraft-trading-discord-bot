        ...
        new Thread(() -> {
            ...
            server.execute(() -> {
                ...
                try {
                    ...
                    if (!stack.isEmpty()) {
                        // Cek apakah inventory penuh: coba offer() dulu (tak menjatuhkan ke lantai).
                        boolean fitted = player.getInventory().insertStack(stack);
                        if (fitted) {
                            player.sendMessage(
                            ...
                            // Inventory penuh: jatuhkan ke lantai + beri tahu pemain.
                            player.dropItem(stack, false);
                            player.sendMessage(
                                text("⚠ Inventory penuh! " + m.itemLabel + " ×" + m.quantity
                                    + " dijatuhkan di dekatmu. Segera ambil!", Formatting.YELLOW),
                                false);
                        }
                    } else {
